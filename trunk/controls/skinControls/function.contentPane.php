...
Function: smarty_function_contentPane
	Handles {contentPane} function in template
...
*/
function smarty_function_contentPane($params, &$skin){
	$result = "&nbsp;";
	...
	if(isset($specialModules[$skin->main->selectedTab])){
  	...
  	$recordSet = $skin->main->databaseConnection->Execute("SELECT  *  
														...
														WHERE 
															...
															AND modules.pane_name='contentpane' 
															AND $moduleSelect
